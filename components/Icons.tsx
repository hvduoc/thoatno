...
export const HeartPulseIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M3.22 12H9.5l.7-1.5L13.5 14l.5-2h6" />
  </svg>
);
...
export const MountainSnowIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m8 3 4 8 5-5 5 15H2L8 3z" />
        <path d="M4.14 15.08c2.62-1.57 5.24-1.43 7.86.42 2.74 1.94 5.49 2.19 8.23.19" />
    </svg>
);
...
export const PiggyBankIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M19.7 13.8c.4-.8.4-1.8 0-2.6l-4.3-7.2c-1-1.6-3-2.4-4.7-2.4H8.3c-1.7 0-3.6.8-4.7 2.4l-1.5 2.5" />
        <path d="M11 12H9" />
        <path d="M15.3 15.3c-1.4 1.4-3.7 1.4-5.1 0l-4.2-4.2c-1.4-1.4-1.4-3.7 0-5.1 1.4-1.4 3.7-1.4 5.1 0l4.2 4.2c1.4 1.4 1.4 3.7 0 5.1z" />
        <path d="m19 17-1 1-1.3-1.3" />
        <path d="M22 13.3V19a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V7.7" />
    </svg>
);
...
export const SparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-3.571a2 2 0 0 0-2.47 2.47l3.57 6.135A2 2 0 0 0 5 21l6.135-3.571a2 2 0 0 0-1.2-1.928Z" />
        <path d="M22 8a2 2 0 0 0-2-2l-3.57 6.135a2 2 0 0 0 1.928 1.2l6.135 3.57a2 2 0 0 0 2.47-2.47Z" />
        <path d="M12 2.5a.5.5 0 0 0-1 0V5a.5.5 0 0 0 1 0Z" />
        <path d="M17.5 5a.5.5 0 0 0-1 0v2.5a.5.5 0 0 0 1 0Z" />
        <path d="M5.5 17a.5.5 0 0 0-1 0v2.5a.5.5 0 0 0 1 0Z" />
    </svg>
);
...
export const HeartHandshakeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.51 4.05 3 5.5l1 1" />
        <path d="M12 5 9.04 7.96a2.17 2.17 0 0 0 0 3.08v0c.82.82 2.13.82 2.94 0l.06-.06L12 11l.96-.96.06-.06a2.17 2.17 0 0 1 2.94 0v0a2.17 2.17 0 0 1 0 3.08L12 17l-4 4" />
        <path d="m15 18-2-2" />
        <path d="m12.5 15.5 5 5" />
    </svg>
);
